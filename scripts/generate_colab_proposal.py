...
WEBSITE_PACKAGES = [
    {
        ...
        "items": [
            ...
            "Social Media Management — account creation (Facebook & Instagram)",
            "Basic business page setup",
            "SSL configuration",
            "30 days support",
        ],
    ...
    },
    {
        ...
        "items": [
            ...
            "Basic SEO",
            "Speed optimization",
            "Social Media Management — profile setup, branding & cover design",
            "Initial launch posts & monthly posting",
            "60 days support",
        ],
        "note": None,
    },
    {
        ...
        "items": [
            ...
            "Admin training",
            "Social Media Management — full management (content, posting & engagement)",
            "Content calendar, stories/reels & monthly performance report",
